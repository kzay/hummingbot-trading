# Global Audit Prompt — Scored /10 per dimension (French version)

> **English summary**: Comprehensive scored audit rating 10 dimensions (A-J: architecture,
> code quality, performance, strategy logic, risk/finance, execution reliability, validation
> parity, observability, security, maintainability) each /10 with overall + semi-pro readiness
> scores. Use at major milestones or quarterly. For recurring reviews, use the 3 loops instead.
