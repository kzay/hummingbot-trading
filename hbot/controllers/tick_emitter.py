...
class TickEmitter:
    ...
    def log_minute(
        ...
        minute_row = {
            ...
            "history_seed_status": str(pd.get("history_seed_status", "disabled")),
            "history_seed_reason": str(pd.get("history_seed_reason", "")),
            "history_seed_source": str(pd.get("history_seed_source", "")),
            "history_seed_bars": str(pd.get("history_seed_bars", 0)),
            "history_seed_latency_ms": str(pd.get("history_seed_latency_ms", 0.0)),
